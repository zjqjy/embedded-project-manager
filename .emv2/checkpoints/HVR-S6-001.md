...
1. `skills/EM-SKILL/commands/arch.md` - 添加 memory-log 和 project-spec 支持
2. `skills/EM-SKILL/templates/history-index.md` - 添加新类型索引格式
3. `skills/EM-SKILL/SKILL.md` - 更新文件结构说明