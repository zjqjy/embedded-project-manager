...
| 工具 | 路径 | 用途 | 步骤 | 调用方式 |
|------|------|------|------|----------|
| `serial-mcp` | `EM-SKILL/plugins/embedded/tools/serial-mcp/` | 串口 GUI 工具（图形化监控） | S5 | MCP |
| `serial-monitor` | `EM-SKILL/plugins/embedded/tools/serial-monitor/` | 串口 CLI 工具（自动化） | S9 | CLI |
| `build-keil` | `EM-SKILL/plugins/embedded/tools/build-keil/` | Keil 编译脚本 | S9 | CLI |
| `flash-openocd` | `EM-SKILL/plugins/embedded/tools/flash-openocd/` | OpenOCD 烧录脚本 | S9 | CLI |
